...
From X's open-sourced algorithm code (March 2023, confirmed in January 2026 xAI release on GitHub).
...
10. [Tweet length performance](#tweet-length-performance)
...
- Competitor platform links (YouTube, Instagram, etc.): −60%
...
- Pin link tweet and drive profile visits via thread content
- Extract key points into a thread, put link at the very end
- Use Premium long-form posts (up to 25K chars) to replace external links entirely

---

## Engagement velocity

**First 30–60 minutes are critical.** Algorithm tests tweet on 5–15% of followers first, then expands or suppresses based on early engagement.
...
**Spam detection trigger:** 10+ tweets in 5 minutes.

Spend 10–15 minutes engaging before posting your own content. This warms up your account signal before the algorithm evaluates your tweet.
...
| External links in post body | −30 to −50% reach |
...
- Algorithm now reads text semantically, not just counting engagement signals
- Watches video content to understand it (not just metadata)
- Sentiment analysis: constructive, educational tone → wider distribution; combative/angry → reduced
- Following feed became Grok-sorted by predicted engagement (Nov 2025)
- January 2026: xAI open-sourced the Grok-powered algorithm on GitHub
- Promptable feeds: users can input natural language commands for their content preferences
...
|-------|------------|----------|
| 71–100 chars | 17% higher engagement rate | Quick hooks, punchy opinions |
| 70–110 chars | Best for retweets | Shareable content (room for RT comments) |
| 240–259 chars | Most total likes | Thought leadership, complete ideas |
| Full 280 | No penalty | When you need the space |
| Premium long-form | Dwell time boost | Deep dives replacing blog links |

6th–7th grade reading level = most retweetable. Emojis count as 2 characters. Links always count as 23 characters regardless of length.

---

## Average engagement rate

Dropped to **0.12% in 2025** (down 48% year-over-year). Volume alone doesn't cut it anymore. High-quality, engagement-optimized content matters more than posting frequently.
