...
**AI/ML:**
- Paper summaries: "new paper from [lab]. they got [X]% improvement on [benchmark] by [method]. the key insight: [one-liner]."
- Tool announcements: "built a small CLI that [does X]. it's rough but [impressive result]. repo link in reply."
- Hot takes: "hot take: fine-tuning is becoming the new premature optimization. most people reaching for LoRA should just write a better prompt."
- Comparisons: "[Model A] vs [Model B] for [task]: here's what I found after testing both:"

**Design:**
- Before/after: "redesigned our settings page. before: 47 toggles on one screen. after: 3 categories with progressive disclosure. same features, 80% less cognitive load."
- Process: "the trick to good data visualization isn't fancy charts. it's removing everything that doesn't directly answer the user's question."
- Craft: "spent an embarrassing amount of time today adjusting the border-radius from 8px to 6px. it's better now. I regret nothing."
- Visual-first: always include screenshots or video. Text-only design tweets underperform.
