...
Humans do this naturally. AI never does. Use sparingly but deliberately to add authenticity.

"She said she'd be there by five but she didn't show up until seven and by then we'd already eaten and honestly I was annoyed."

### Emotional markers

Real humans show emotion in writing. See [cultural-styles.md](references/cultural-styles.md) for the full list. Surprise ("Wait, what?"), frustration ("ugh"), excitement ("This is HUGE!"), sarcasm ("Oh, great."), emphasis via caps ("DO NOT do this."). One or two per 500 words max.
