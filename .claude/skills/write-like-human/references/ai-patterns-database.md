...
**Em dash overuse:** AI uses em dashes 2-5x more than human baseline (2.5-2.75 per 1000 words in human writing). GPT-4o uses roughly 10x more than GPT-3.5. Often used formulaically: "it's not X — it's Y." Keep to max 1 per 500 words.
...
### Cliched significance claims (never use)
...
### Metaphorical cliches (never use)
...
### Wikipedia-specific AI phrases (never use in encyclopedic-style writing)
...
### Conclusions and transitions (never use)
...
- "At the end of the day" (as transition)
- "When it comes to"
- "In terms of"
...
Perplexity detection threshold: above 85 likely human, below 20 likely AI (GPTZero).

Note: AI detection tools evolve constantly. Companies read detection lists and adjust model outputs. "Delve" was massively overused in 2023-early 2024, then dropped sharply. Em dash overuse emerged with GPT-4o and persists across all major models. Patterns need periodic review.
